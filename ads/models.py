...
from dim.models import DimSuite, DimSystem, DimVendor, DimDate, DimCpu, DimSystemSeries
from dwd.models import DwdTestInfo


class AdsBenchmark(models.Model):
    test_info = models.ForeignKey(DwdTestInfo, on_delete=models.CASCADE, related_name='ads_benchmark')

    suite = models.ForeignKey(DimSuite, on_delete=models.CASCADE, related_name='ads_benchmark')
    suite_name = models.CharField(max_length=300, default='')
    ...
    cpu_type = models.CharField(max_length=100, default='')
    ...
    time_level = models.CharField(max_length=100, default='')
...
class AdsSystem(models.Model):
    ...
    system_series = models.ForeignKey(DimSystemSeries, on_delete=models.CASCADE, related_name='ads_system')
    ...
    best_rank_test = models.ForeignKey(DwdTestInfo, on_delete=models.CASCADE, related_name='ads_system')
