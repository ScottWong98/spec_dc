...
class OdsSpecModel(models.Model):
    suite = models.CharField(verbose_name="套件名称", max_length=100, default='')
    ...
    cpu_name = models.CharField(verbose_name="cpu 名字", max_length=400, default='')
    ...
    l1_cache = models.CharField(verbose_name="一级缓存", max_length=600, default='')
    l2_cache = models.CharField(verbose_name="二级缓存", max_length=600, default='')
    l3_cache = models.CharField(verbose_name="三级缓存", max_length=600, default='')
    memory = models.CharField(verbose_name="内存信息", max_length=600, default='')
    ...
    storage = models.CharField(verbose_name="硬盘信息", max_length=600, default='')
    os = models.CharField(verbose_name="OS信息", max_length=600, default='')
    file_system = models.CharField(verbose_name="文件系统", max_length=100, default='')
    jvm = models.CharField(verbose_name="JVM信息", max_length=600, default='')
    url_suffix = models.CharField(verbose_name="url后缀", max_length=400, default='')
    ...
    full_url = models.CharField(verbose_name="URL链接", max_length=400, default='')
